...
public class HibernateSurveyServiceTest {
    ...
    public void addSurvey() {
        ...
        Survey survey = new Survey("Do you like programming?", false, Category.SCIENCE, createOptionNames("Yes", "No"), newHashSet("COMMON_TAG", "TAG1"));
        surveyService.addSurvey(user, survey);

        User userById = userService.getUserById(userId);
        assertEquals(1, userById.getSurveys().size());
    ...
    public void findSurveyByTag() {
        ...
        Survey survey = new Survey(content, false, Category.SCIENCE, optionNames, tags1);
        surveyService.addSurvey(user, survey);

        Survey survey2 = new Survey(content, false, Category.SCIENCE, optionNames, tags2);
        surveyService.addSurvey(user, survey2);
    ...
    public void deleteSurvey() {
        ...
        List<String> optionNames = createOptionNames("Yes", "No");
        String content = "Do you like programming?";
        Survey survey1 = new Survey(content, false, Category.SCIENCE, optionNames, newHashSet("COMMON_TAG", "TAG1"));
        long surveyId1 = surveyService.addSurvey(user, survey1);
        String content2 = "How do you love China?";
        Survey survey2 = new Survey(content2, false, Category.SCIENCE, optionNames, newHashSet("COMMON_TAG", "TAG1"));
        surveyService.addSurvey(user, survey2);
        ...
        surveyService.removeSurvey(user, surveyId1);
        List<Survey> allSurveys = surveyService.getAllSurveys();
    ...
    public void getSurveyByUser() {
        ...
        long userId = userService.addUser(user);
        String content = "Do you like programming?";
        Survey survey = new Survey(content, false, Category.SCIENCE, createOptionNames("Yes", "No"), newHashSet("COMMON_TAG", "TAG1"));
        surveyService.addSurvey(user, survey);

        Survey survey2 = new Survey("Do you like China?", false, Category.SCIENCE, createOptionNames("Yes", "No"), newHashSet("COMMON_TAG", "TAG1"));
        surveyService.addSurvey(user, survey2);
    ...
    public void getSurveyByCategory() {
        ...
        surveyService.addSurvey(user, survey1);
